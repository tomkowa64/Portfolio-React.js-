  ...
  return (
    <section className="start" id="start">
        <Container fluid={true}>
          <Row>
            <Col sm={5} className="portfolio-image">
              <Image src="portfolio-image.png" fluid />
            </Col>
            <Col sm={7}>
              <Container className="portfolio-title">
                <Row className="name">
                  <p className="full-name">Tomasz Kowalski</p>
                  <p className="job-title font-weight-bold">Front End Developer & UI Designer</p>
                </Row>
                <Row className="portfolio-title-line">
